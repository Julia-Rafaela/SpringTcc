...
public class VendaController {
		...
		try {
			...
			if (cmd != null) {
				if (cmd.equals("Realizar Venda")) {
					...
					saida = realizarVenda(allRequestParam, codigo, data, formaPagamento);
					codigo = "";
	...
	private String realizarVenda(Map<String, String> allRequestParam, String codigo, String data, String formaPagamento) {
			String saida = "";
			try {
				...
				if (key.startsWith("quantidade")) {
					...
					if (quantidadeStr != null && !quantidadeStr.isEmpty()) {
						...
						if (produtoValue != null && !produtoValue.isEmpty()) {
							...
							saida = cadastrarVenda(vendaNova);
						}
					}
				}
			}
